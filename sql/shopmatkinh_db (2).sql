...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 14, 2024 lúc 03:16 PM
...
--
-- Cơ sở dữ liệu: `shopmatkinh_db`
--

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `chatlieusp`
--
...
--
-- Đang đổ dữ liệu cho bảng `chatlieusp`
--
...
INSERT INTO `chitiethoadon` (`ma`, `maHD`, `maSP`, `soluong`, `tongtien`) VALUES
(39, 51, 14, 2, 5160000),
(40, 52, 17, 1, 2980000),
(41, 53, 16, 1, 2740000),
(42, 54, 10, 1, 2580000),
...
--
-- Cấu trúc bảng cho bảng `doituongsd`
--
...
--
-- Đang đổ dữ liệu cho bảng `doituongsd`
--
...
CREATE TABLE `hoadon` (
  `maHD` int(11) NOT NULL,
  `ngayxuatHD` varchar(100) NOT NULL,
...
INSERT INTO `hoadon` (`maHD`, `ngayxuatHD`, `mataikhoan`, `thanhtien`, `trangthai`, `tennguoinhan`, `diachi`, `sodienthoai`) VALUES
(51, '2024-05-10', 2, 5160000, 2, '', '', ''),
(52, '2024-05-13', 2, 2980000, 2, '', '', ''),
(53, '2024-05-14', 2, 2740000, 2, '', '', ''),
(54, '2024-05-14', 2, 15480000, 2, '', '', ''),
(55, '2024-05-14', 2, 2540000, 2, '', '', ''),
(56, '2024-05-14', 2, 0, 3, '', '', ''),
(57, '2024-05-14', 8, 5160000, 0, '', '', ''),
(58, '2024-05-14', 8, 2580000, 0, '', '', ''),
(59, '2024-05-14', 3, 2580000, 0, '', '', ''),
(60, '2024-05-14', 8, 2580000, 0, '', '', '');
...
(13, 'eco²xy\r\nECO2029N-4S', 2, 2450000, 8, 4, 2, 'ECO2029N-4S'),
(14, 'eco²xy\r\nECO2028N-4S', 4, 2580000, 8, 4, 2, 'ECO2028N-4S'),
(15, 'eco²xy\r\nECO2027N-4S', 100, 2540000, 5, 4, 2, 'ECO2027N-4S'),
(16, 'eco²xy\r\nECO2026N-4S', 100, 2740000, 4, 4, 2, 'ECO2026N-4S'),
...
(25, 'AIR FIT\r\nAF1035G-3A', 100, 1780000, 8, 1, 4, 'AF1035G-3A'),
...
(133, 'eco²xy\r\nECO2017K-0A', 100, 2740000, 3, 4, 2, 'ECO2017K-0A'),
...
(163, 'eco²xy\r\nECO2016K-0S', 100, 2980000, 1, 3, 2, 'ECO2016K-0S'),
...
INSERT INTO `users` (`userID`, `password`, `sodienthoai`, `email`, `username`, `hovaten`, `diachi`, `role_id`, `trangthai`) VALUES
(2, 'admin', '0123456789', 'admin@gmail.com', 'admin', 'admin', '0 admin', 0, 0),
(3, 'quanly', '0123456789', 'quanly@gmail.com', 'quanly', 'quanlyabc', 'quanly', 1, 1),
(4, 'nhanvien', '0123456789', 'nhanvien@gmail.com', 'nhanvien', 'nhanvien', 'nhanvien', 2, 0),
(6, '123', '0123456789', 'av@gmail.com', 'kh', 'khach', 'asd', 3, 0),
(7, 'a', '0983746151', 'he@gmail.com', 'hang', 'hang', '28 nt', 3, 1),
(8, '123', '0983746151', 'he@gmail.com', 'he', 'da', '28 nt', 3, 1);
...
--
-- AUTO_INCREMENT cho bảng `chatlieusp`
--
ALTER TABLE `chatlieusp`
...
--
ALTER TABLE `chitiethoadon`
  MODIFY `ma` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT cho bảng `doituongsd`
--
ALTER TABLE `doituongsd`
...
--
ALTER TABLE `hoadon`
  MODIFY `maHD` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
...
--
ALTER TABLE `roles`
  MODIFY `ma` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `sanpham`
--
ALTER TABLE `sanpham`
  MODIFY `maSP` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;
...
--
ALTER TABLE `hoadon`
  ADD CONSTRAINT `tt` FOREIGN KEY (`trangthai`) REFERENCES `trangthai` (`ma`);
